...
class Music:
    ...
    def extract_features(self):
        ...
        mfcc = librosa.feature.mfcc(S=mel_spectrum,n_mfcc=3) # mfcc[3]
...
def audio_feature_extract(data_dir,over_write=False):
    ...
    if  os.path.exists(acoustic_features_path) and os.path.exists(temporal_indexes_path) and not over_write:
