...
parser.add_argument('-m', '--model_save_dir', default='./model/C/music_vae_model', type=str, help='model save dir')
parser.add_argument('-l', '--log_dir',default='./music_log', type=str, help='log save dir')
